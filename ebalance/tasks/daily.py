...
def sync_report_periods():
    ...
    try:
        ...
        frappe.log_error(
            message=f"Period sync failed: {str(e)}",
    ...
    try:
        ...
        for request in pending_requests:
            ...
            try:
                ...
                frappe.log_error(
                    message=f"Status check failed for {request.name}: {str(e)}",
        ...
        frappe.log_error(
            message=f"Pending report check failed: {str(e)}",
...
def send_deadline_reminders():
    ...
    try:
        ...
        frappe.log_error(
            message=f"Deadline reminder failed: {str(e)}",
